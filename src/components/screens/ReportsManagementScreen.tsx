...
export const ReportsManagementScreen: React.FC = () => {
  ...
  return (
    <div className="pb-24 px-3 sm:px-4 pt-3 max-w-xl mx-auto space-y-4 w-full">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1.5 -mx-3 px-3 sm:-mx-4 sm:px-4 scrollbar-none">
        <button
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-[11px] -mx-3 px-3 sm:-mx-4 sm:px-4 scrollbar-none">
            ...
            return (
              ...
              >
                ...
                {p.linkedDuplicatesCount > 0 && (
                  <div className="mt-2 p-1.5 rounded-lg bg-[#FFDDAE]/40 border border-[#7B5300]/20 text-[11px] text-[#7B5300] flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {p.status === 'SOLVED' ? (
                      ...
                      <button
                        ...
                        className="touch-target min-h-[42px] flex-1 px-3 py-2 rounded-xl bg-[#A03818] text-white text-xs font-['Epilogue'] font-bold flex items-center justify-center gap-1.5 shadow-xs hover:bg-[#842504] active:scale-98 cursor-pointer transition-all"
